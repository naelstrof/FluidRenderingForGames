	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				finalColor = ( vertexToFrag265 * ( tex2D( _MainTex, vertexToFrag239 ).r * vertexToFrag265.w ) );
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.CustomExpressionNode;22;432,512;Inherit;False;GetGrassInstance(instanceID, vertexID, grassMat, localPosition, localNormal, uv)@;7;File;6;True;vertexID;OBJECT;0;In;uint;Inherit;False;True;instanceID;OBJECT;0;In;uint;Inherit;False;True;localPosition;FLOAT3;0,0,0;Out;;Inherit;False;True;localNormal;FLOAT3;0,0,0;Out;;Inherit;False;True;uv;FLOAT2;0,0;Out;;Inherit;False;True;color;FLOAT4;0,0,0,0;Out;;Inherit;False;GetParticle;False;False;0;be738ec41f05d8b4ba53d30aa46319dc;False;7;0;FLOAT;0;False;1;OBJECT;0;False;2;OBJECT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT2;0,0;False;6;FLOAT4;0,0,0,0;False;5;FLOAT;0;FLOAT3;4;FLOAT3;5;FLOAT2;6;FLOAT4;7
Node;AmplifyShaderEditor.VertexToFragmentNode;239;736,416;Inherit;False;False;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.VertexToFragmentNode;265;752,592;Inherit;False;False;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
