	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				#endif
				float4 color1 = IsGammaSpace() ? float4(1,0,0,0.2705882) : float4(1,0,0,0.2705882);
